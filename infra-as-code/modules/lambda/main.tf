...
module "permissions" {
  ...
  CREATE_ECS_PERMISSIONS        = var.CREATE_ECS_PERMISSIONS
  CREATE_EC2_PERMISSIONS        = var.CREATE_EC2_PERMISSIONS
  CREATE_EKS_LAMBDA_PERMISSIONS = var.CREATE_EKS_LAMBDA_PERMISSIONS
}
